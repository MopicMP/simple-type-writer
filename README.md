...
> Simple typewriter text animation effect

[![npm version](https://badge.fury.io/js/simple-type-writer.svg)](https://www.npmjs.com/package/simple-type-writer)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install simple-type-writer
```

## Quick Start

```javascript
const { writer } = require('simple-type-writer');
...
```javascript
const { writer, batch } = require('simple-type-writer');
